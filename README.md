...
## Adding a IdahoLayer from Python

```python
plugin = qgis.utils.plugins.get("IdahoLayerPlugin")
if plugin:
  from IdahoLayerPlugin.tiles import BoundingBox, IdahoLayerDefinition
  bbox = None    # BoundingBox(-180, -85.05, 180, 85.05)
  layerdef = IdahoLayerDefinition(u"title",
                                 u"attribution",
                                 "http://example.com/xyz/{z}/{x}/{y}.png",
                                 zmin=1,
                                 zmax=18,
                                 bbox=bbox)
  plugin.addIdahoLayer(layerdef)
else:
  from PyQt4.QtGui import QMessageBox
  QMessageBox.warning(None,
                      u"IdahoLayerPlugin not installed",
...
version 0.50.1  
* IdahoLayerPlugin doesn't support map rotation now. Shows message and does not render tiles if map canvas is rotated.
...
## License
IdahoLayerPlugin is free software; you can redistribute it and/or modify it under the terms of the GNU General Public License as published by the Free Software Foundation; either version 2 of the License, or (at your option) any later version.
